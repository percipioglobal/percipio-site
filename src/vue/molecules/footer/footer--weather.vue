...
<template>
    <div> 
        ...
        >
            ...
            <AnimationWeather v-if="weather[location]?.weather[0]?.icon === '01d' || weather[location]?.weather[0]?.icon ==='01n'" :animationWeather="ZeroOneD"/>
            <AnimationWeather v-if="weather[location]?.weather[0]?.icon === '02d' || weather[location]?.weather[0]?.icon ==='02n'" :animationWeather="ZeroTwoD"  />
            <AnimationWeather v-if="weather[location]?.weather[0]?.icon === '03d' || weather[location]?.weather[0]?.icon ==='03n'" :animationWeather="ZeroThreeD" />
            <AnimationWeather v-if="weather[location]?.weather[0]?.icon === '04d' || weather[location]?.weather[0]?.icon ==='04n'" :animationWeather="ZeroFourD" />
            <AnimationWeather v-if="weather[location]?.weather[0]?.icon === '09d' || weather[location]?.weather[0]?.icon ==='09n'" :animationWeather="ZeroNineD" />
            <AnimationWeather v-if="weather[location]?.weather[0]?.icon === '10d' || weather[location]?.weather[0]?.icon ==='10n'" :animationWeather="OneZeroD" />
            <AnimationWeather v-if="weather[location]?.weather[0]?.icon === '11d' || weather[location]?.weather[0]?.icon ==='11n'" :animationWeather="OneOneD" />
            <AnimationWeather v-if="weather[location]?.weather[0]?.icon === '13d' || weather[location]?.weather[0]?.icon ==='13n'" :animationWeather="OneThreeD" />
            <AnimationWeather v-if="weather[location]?.weather[0]?.icon === '50d' || weather[location]?.weather[0]?.icon === '50n'" :animationWeather="FiveZeroD" />
